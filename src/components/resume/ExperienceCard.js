...
const ExperienceCard = ({ position, year, company, description }) => {
  return (
    <div className="w-full h-[120vh] sm:h-[90vh] md:h-[90vh] xl:h-[60vh] flex items-center justify-center">
    <div className="w-full h-auto md:w-[90%] mdl:w-[65%] flex justify-center items-center py-5 lg:mx-48 px-5">

...
const SkillsCard = ({ title, img, des }) => {
  return (
    <>
        <div className="w-full h-[15em] bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg px-10 flex justify-between item-center shadow-shadowOne relative mb-10 group">
